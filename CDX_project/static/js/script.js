function ValidLogForm(f) {
	...
	if (f.username.value.length < 10 || f.username.value.length > 16) {document.getElementById("user_error").innerHTML = "Please pick a username that is not less than 10 or more than 16 characters."; return false;}
	if (f.password.value.length < 14 || f.password.value.length > 20) {document.getElementById("password_error").innerHTML = "The password should be between 14 and 20 characters."; return false;}
	return true; }
